...
channel_depth = 1024               # bounded per-connection outbound channel; must be > 0
max_connections = 64               # hard cap on concurrent clients (must be > 0); accepts past this close immediately
